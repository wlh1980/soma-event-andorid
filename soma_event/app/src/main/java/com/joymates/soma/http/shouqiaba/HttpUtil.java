...
//                checkTokenSuccess(context, response.body());
    ...
    public static void post(final Context context, final Handler handler, final String url, final org.json.JSONObject
            jb, String sign, String sn, final Class<?> clazz, final int type, final int successState, final int errorState) {
        post(context, handler, url, jb.toString(), sign, sn, clazz, type, successState, errorState, false);
    }

    public static void post(final Context context, final Handler handler, final String url, final org.json.JSONObject
            jb, String sign, String sn, final Class<?> clazz, final int type, final int successState, final int errorState, boolean
                                    isShowLoading) {
        post(context, handler, url, jb.toString(), sign, sn, clazz, type, successState, errorState, isShowLoading);
    }

    public static void post(final Context context, final Handler handler, final String url, final String
            jb, String sign, String sn, final Class<?> clazz, final int type, final int successState, final int errorState) {
        post(context, handler, url, jb, sign, sn, clazz, type, successState, errorState, false);
    }

    public static void post(final Context context, final Handler handler, final String url, final String param,
                            String sign, String sn, final Class<?> clazz, final int type, final int successState, final int errorState,
                            boolean isShowLoading) {
        post(context, handler, url, param, sign, sn, clazz, type, successState, errorState, isShowLoading, false);
    }
    ...
    public static void post(final Context context, final Handler handler, final String url, final String param,
        ...
        LogUtils.e("Authorization=" + sn + " " + sign);
...
//                return;
//            }
//            SomaUtils.jPushDeleteAlias(context);
...
//                            Delete.tables(OrderEntity.class, OrderInfoEntity.class, OrderSpecEntity.class);
