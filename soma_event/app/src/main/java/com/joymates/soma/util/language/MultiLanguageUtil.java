package com.joymates.soma.util.language;
...
public class MultiLanguageUtil {
    ...
    private void getSystemLanguage(Locale locale) {
        locale.getLanguage();
        locale.getCountry();
    }
...
//        EventBus.getDefault().post(new OnChangeLanguageEvent(languageType));
    ...
    public String getLanguageName() {
        int languageType = SPUtils.getInstance().getInt(MultiLanguageUtil.SAVE_LANGUAGE, LanguageType
